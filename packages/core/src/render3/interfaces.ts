...
import { Injector, TemplateRef, ViewContainerRef, ElementRef, Type, QueryList } from '@angular/core';
import { RElement, RText, RComment } from './renderer';
...
export interface LNodeInjector {
  ...
  /** Stores the ViewContainerRef so subsequent injections of the ViewContainerRef get the same instance. */
 ...
 */
export type MinificationData = {[key: string]: MinificationDataValue};
...
export type MinificationDataValue  =
    {inputs?: (number | string)[], outputs?: (number | string)[]};
