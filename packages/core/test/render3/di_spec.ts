...
import {
  injectElementRef, injectTemplateRef, injectViewContainerRef, defineDirective,
  inject, E, e, T, t, b, b2, D, C, c, V, v, rC, rc, PublicFeature
} from '../../src/render3/index';
import { renderToHtml } from './render_util';
import { LNodeInjector, LNodeFlags } from '../../src/render3/interfaces';
import { bloomAdd, createNode, createViewState, enterView, leaveView, getOrCreateNodeInjector } from '../../src/render3/instructions';
...
describe('di', () => {
  ...
  describe('view dependencies', () => {
    it('should create directive with inter view dependencies', () => {
      ...
      class DirectiveC {
        value: string;
        constructor(a: DirectiveA, b: DirectiveB) {
  ...
  describe('inject', () => {
    describe('bloom filter', () => {
      ...
      function bloomState() {
        return [di.bf3, di.bf2, di.bf1, di.bf0];
      }
