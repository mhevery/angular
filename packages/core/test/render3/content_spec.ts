...
import { D, E, e, P, T, C, c, V, v, rC, rc, detectChanges } from '../../src/render3/index';
import { renderComponent, toHtml, createComponent } from './render_util';
...
describe('content projection', () => {
  ...
  it('should re-project content when root.', () => {
    ...
    const parent = renderComponent(Parent);
    expect(toHtml(parent)).toEqual('<child><grand-child><div><b>Hello</b>World!</div></grand-child></child>');
  });
