...
import { ComponentTemplate, renderComponent as _renderComponent, ComponentType, defineComponent, PublicFeature } from '../../src/render3/index';
import { createNode, createViewState, NG_HOST_SYMBOL, renderTemplate } from '../../src/render3/instructions';
import { Renderer3, RElement, RText } from '../../src/render3/renderer';

(global as any).ngDevMode = true;

export const document = typeof window == 'undefined' ? createWindow('', 'http://localhost').document : global.document;
...
export function createComponent(name: string, template: ComponentTemplate<any>): ComponentType<any> {
