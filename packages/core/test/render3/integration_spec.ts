...
import {
  defineComponent, r,
  E, e, T, t, a, p, b, bV, b1, b2, b3, b4, b5, b6, b7, b8, s, D,
  k, rC, rc, C, c, V, v, i, NC, defineDirective
} from '../../src/render3/index';
import { renderToHtml, containerEl } from './render_util';
import {mergeInputsAndOutputs, NO_CHANGE} from '../../src/render3/instructions';
...
describe('iv integration test', () => {
  ...
  describe('text bindings', () => {
    ...
    it('should support creation-time bindings in interpolations', () => {
      function Template(v: string, cm: boolean) {
        ...
        t(8, bV(['', v, '_', v, '_', v, '_', v, '_', v, '_', v, '_', v, '_', v, '_', cm ? v : NC, '']));
      }
      expect(renderToHtml(Template, 'a')).toEqual('a|a_a|a_a_a|a_a_a_a|a_a_a_a_a|a_a_a_a_a_a|a_a_a_a_a_a_a|a_a_a_a_a_a_a_a|a_a_a_a_a_a_a_a_a');
      expect(renderToHtml(Template, 'A')).toEqual('a|A_a|A_A_a|A_A_A_a|A_A_A_A_a|A_A_A_A_A_a|A_A_A_A_A_A_a|A_A_A_A_A_A_A_a|A_A_A_A_A_A_A_A_a');
    });
  ...
  describe('Siblings update', () => {
    ...
    it('should update 2 sibling elements', () => {
      ...
      expect(renderToHtml(Template, 'foo')).toEqual('<b><span></span><span class="foo" id="foo"></span></b>');
      expect(renderToHtml(Template, 'bar')).toEqual('<b><span></span><span class="foo" id="bar"></span></b>');
    });
  ...
  describe('basic components', () => {
    ...
    it('should support a component template with component sibling', () => {
      ...
      expect(renderToHtml(Template, null)).toEqual('<todo><p>Todo one</p></todo><todo><p>Todo one</p></todo>');
    });
    ...
    it('should support a component with binding on host element', () => {
      ...
      class TodoComponentHostBinding {
          ...
          static ngComponentDef = defineComponent({
              ...
              tag: 'todo',
              template: function TodoComponentHostBindingTemplate(ctx: TodoComponentHostBinding, cm: boolean) {
                if (cm) {
                  T(0);
                }
                t(0, b(ctx.title))
      ...
      function Template(ctx: any, cm: boolean) {
        if (cm) {
          E(0, TodoComponentHostBinding.ngComponentDef); {
            D(0, TodoComponentHostBinding.ngComponentDef.n(), TodoComponentHostBinding.ngComponentDef);
          } e();
        }
    ...
    it('should support component with bindings in template', () => {
      ...
      class MyComp {
        name = 'Bess';
        static __generated__ = defineComponent({
          type: MyComp,
          tag: 'comp',
      ...
      function Template(ctx: any, cm: boolean) {
        if (cm) {
          E(0, MyComp.__generated__); {
            D(0, MyComp.__generated__.n(), MyComp.__generated__);
          } e();
        }
        MyComp.__generated__.r(0, 0);
      }
    ...
    it('should support a component with sub-views', () => {
      ...
      function Template(ctx: any, cm: boolean) {
        ...
        let temp;
        i(temp = b(ctx.condition)) && (D<MyComp>(0).condition = temp);
        MyComp.__generated__.r(0, 0);
      }
  ...
  describe('element bindings', () => {
    ...
    describe('elementAttribute', () => {
      ...
      it('should update bindings', () => {
        function Template(c: any, cm: boolean) {
          ...
          a(0, 'a6', b6(c[0], c[1], c[2], c[3], c[4], c[5], c[6], c[7], c[8], c[9], c[10], c[11], c[16]));
          a(0, 'a7', b7(c[0], c[1], c[2], c[3], c[4], c[5], c[6], c[7], c[8], c[9], c[10], c[11], c[12], c[13], c[16]));
          a(0, 'a8', b8(c[0], c[1], c[2], c[3], c[4], c[5], c[6], c[7], c[8], c[9], c[10], c[11], c[12], c[13], c[14], c[15], c[16]));
        }
        let args = ['(', 0, 'a', 1, 'b', 2, 'c', 3, 'd', 4, 'e', 5, 'f', 6, 'g', 7, ')'];
        expect(renderToHtml(Template, args)).toEqual('<b a="(0a1b2c3d4e5f6g7)" a0="0" a1="(0)" a2="(0a1)" a3="(0a1b2)" a4="(0a1b2c3)" a5="(0a1b2c3d4)" a6="(0a1b2c3d4e5)" a7="(0a1b2c3d4e5f6)" a8="(0a1b2c3d4e5f6g7)"></b>');
        args = args.reverse();
        expect(renderToHtml(Template, args)).toEqual('<b a=")7g6f5e4d3c2b1a0(" a0="7" a1=")7(" a2=")7g6(" a3=")7g6f5(" a4=")7g6f5e4(" a5=")7g6f5e4d3(" a6=")7g6f5e4d3c2(" a7=")7g6f5e4d3c2b1(" a8=")7g6f5e4d3c2b1a0("></b>');
        args = args.reverse();
        expect(renderToHtml(Template, args)).toEqual('<b a="(0a1b2c3d4e5f6g7)" a0="0" a1="(0)" a2="(0a1)" a3="(0a1b2)" a4="(0a1b2c3)" a5="(0a1b2c3d4)" a6="(0a1b2c3d4e5)" a7="(0a1b2c3d4e5f6)" a8="(0a1b2c3d4e5f6g7)"></b>');
      });
      ...
      it('should not update DOM if context has not changed', () => {
        ...
        // initial binding
        expect(renderToHtml(Template, ctx)).toEqual('<span title="Hello"><b title="Hello"></b></span>');
        // update DOM manually
        containerEl.querySelector('b')!.setAttribute('title', 'Goodbye');
        // refresh with same binding
        expect(renderToHtml(Template, ctx)).toEqual('<span title="Hello"><b title="Goodbye"></b></span>');
    ...
    describe('elementProperty', () => {
      ...
      it('should check input properties before setting (directives)', () => {
        ...
        // Only elements with both directives and property bindings need a merged object
        const ID0 = mergeInputsAndOutputs([0, MyButton.ngDirectiveDef, 1, OtherDir.ngDirectiveDef]);
        ...
        function Template(ctx: any, cm: boolean) {
          ...
          p(0, 'disabled', b(ctx.isDisabled), ID0);
          p(0, 'id', b(ctx.id), ID0);
        }
      ...
      it('should support mixed element properties and input properties', () => {
        ...
        // Only elements with both directives and property bindings need a merged object
        const ID0 = mergeInputsAndOutputs([0, MyButton.ngDirectiveDef]);
      ...
      it('should check that property is not an input property before setting (component)', () => {
        ...
        const ID0 = mergeInputsAndOutputs([0, Comp.ngComponentDef]);
      ...
      it('should support two input properties with the same name', () => {
        ...
        const ID0 = mergeInputsAndOutputs([0, MyButton.ngDirectiveDef, 1, OtherDisabledDir.ngDirectiveDef]);
    ...
    describe('elementStyle', () => {
      ...
      it('should support binding to styles', () => {
        ...
        expect(renderToHtml(Template, 'green')).toEqual('<span style="border-color: green;"></span>');
